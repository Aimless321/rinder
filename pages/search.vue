  ...
  <div class="flex flex-col overflow-scroll px-2">
    <div class="relative mb-5">
      <input type="email" name="email" id="email"
             class="block w-full rounded-full border-0 py-3 pl-3 pr-10 text-gray-900 bg-white shadow-lg mt-1 ring-1 ring-gray-100 placeholder:text-gray-500 focus:outline-none"
